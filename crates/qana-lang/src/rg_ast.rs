...
use qana_grammar::typed::{AstNode, NodeRef, TokenRef};
...
impl<'g> AstNode<'g> for Decls<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 1 && node.prod() == qana_grammar::green::LIST_PROD).then(|| Decls(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
    ...
    pub fn items(&self) -> Vec<Decl<'g>> {
        self.0
            ...
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => Decl::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for TokenDefs<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 4 && node.prod() == qana_grammar::green::LIST_PROD).then(|| TokenDefs(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> TokenDefs<'g> {
    pub fn items(&self) -> Vec<TokenDef<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => TokenDef::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for KwList<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 5 && node.prod() == qana_grammar::green::LIST_PROD).then(|| KwList(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> KwList<'g> {
    pub fn items(&self) -> Vec<KwItem<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => KwItem::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for Attrs<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 8 && node.prod() == qana_grammar::green::LIST_PROD).then(|| Attrs(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> Attrs<'g> {
    pub fn items(&self) -> Vec<Attr<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => Attr::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for ArgList<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 10 && node.prod() == qana_grammar::green::LIST_PROD).then(|| ArgList(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> ArgList<'g> {
    pub fn items(&self) -> Vec<Arg<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => Arg::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for PrecOps<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 14 && node.prod() == qana_grammar::green::LIST_PROD).then(|| PrecOps(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> PrecOps<'g> {
    pub fn items(&self) -> Vec<TokRef<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => TokRef::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for AltList<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 15 && node.prod() == qana_grammar::green::LIST_PROD).then(|| AltList(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> AltList<'g> {
    pub fn items(&self) -> Vec<Alt<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => Alt::cast(n),
                _ => None,
            })
            .collect()
    }
...
impl<'g> AstNode<'g> for Syms<'g> {
    fn cast(node: NodeRef<'g>) -> Option<Self> {
        (node.nt() == 17 && node.prod() == qana_grammar::green::LIST_PROD).then(|| Syms(node))
    }
    fn node(&self) -> NodeRef<'g> {
        self.0
    }
...
impl<'g> Syms<'g> {
    pub fn items(&self) -> Vec<Sym<'g>> {
        self.0
            ...
            .into_iter()
            .filter_map(|c| match c {
                qana_grammar::typed::SymbolChild::Node(n) => Sym::cast(n),
                _ => None,
            })
            .collect()
    }

...
//! qana get native-editor reach — Neovim, Helix, Zed, GitHub — for
...
use qana_grammar::model::{Action, LexGrammar, TokenId};
use qana_grammar::pat::{ClassSet, Pat};
use qana_grammar::syn::{Assoc, Sym, SynGrammar};
use qana_grammar::LrTables;
use qana_sem::BindingConfig;
use qana_services::Styles;
...
pub fn emit_tree_sitter(
    ...
    writeln!(js, "// @generated by qana (qana2ts). DO NOT EDIT.").unwrap();
    ...
    writeln!(scm, "; @generated by qana (qana2ts). DO NOT EDIT.").unwrap();
